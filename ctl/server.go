...
func BuildServerFlags(cmd *cobra.Command, srv *server.Command) {
	...
	flags.StringVar(&srv.Config.ListenAddr, "listen-addr", srv.Config.ListenAddr, "Address on which pilosa should listen.")
	flags.StringVar(&srv.Config.ListenAddr, "advertise-addr", srv.Config.ListenAddr, "Address to advertise externally.")
