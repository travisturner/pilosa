...
func OptNodeClient(c *http.Client) NodeOption {
...
func (a *remoteAPI) FragmentBlocks(ctx context.Context, index, frame, view string, slice uint64) ([]FragmentBlock, error) {
